    ...
    public void zoomMainActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withText("Zoom"),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("Zoom")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withText("Zoom"),
                        ...
                        isDisplayed()));
        textView2.check(matches(withText("Zoom")));
